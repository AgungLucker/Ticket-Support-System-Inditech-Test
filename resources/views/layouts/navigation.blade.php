...
<div class="flex h-14 shrink-0 items-center border-b border-indigo-800 px-4">
    <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
        <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shrink-0">
            <svg class="w-5 h-5 text-indigo-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<nav class="flex-1 overflow-y-auto p-3">
    ...
    @can('access-admin')
        ...
        <div class="space-y-0.5">
            ...
            <a href="{{ route('admin.teams.index') }}" class="{{ request()->routeIs('admin.teams.*') ? $active : $inactive }}">
                <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
